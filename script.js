...
async function getData(season, currentStat){
        ...
        if (currentStat === "avg"){
                ...
                stat = "avg";
                let avgColumn = document.getElementById("avgColumn");
                avgColumn.textContent = "AVG";
                let preAdjustColumn = document.getElementById("preAdjustColumn");
                preAdjustColumn.textContent = "ORIG. AVG";
        }
        if (currentStat === "era"){
                ...
                stat = "era";
                let avgColumn = document.getElementById("avgColumn");
                avgColumn.textContent = "ERA";
                let preAdjustColumn = document.getElementById("preAdjustColumn");
                preAdjustColumn.textContent = "ORIG. ERA";
        }
